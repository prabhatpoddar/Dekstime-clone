...
export default function Signup() {
  ...
  return (
    <Grid gap={5}>
      <GridItem>
        <Grid mt="60px" gap={5}>
          <Heading fontSize="42px" >Sign up for a FREE DeskTime trial</Heading>
          <Text>Start tracking your productivity in less than a minute!</Text>
        </Grid>
      </GridItem>
      <GridItem>
      ...
      <GridItem>
        <Grid>
          ...
          <Text> By signing up, you agree to our <b><u>terms</u></b> and <b><u>privacy</u></b></Text>
          <Text> <b><u>policy</u></b>.</Text>
        </Grid>
      </GridItem>
      <GridItem mt={5}>
